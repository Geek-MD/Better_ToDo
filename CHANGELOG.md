...
### Fixed
- **Custom recurrence dialog upgrade**: versioned the panel JavaScript URL so Home Assistant clients fetch the friendly recurrence dialogs from v0.6 instead of reusing a cached bundle that still displayed the raw RRULE field.
